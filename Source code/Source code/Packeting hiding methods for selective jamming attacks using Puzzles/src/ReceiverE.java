...
public class ReceiverE extends JFrame implements ActionListener {
	...
	public JLabel T0 = new JLabel(" ReceiverE");
		...
		try {
			...
			while (true) {
				...
				if (result.equals(xx)) {
					...
					ImageIcon img11 = new ImageIcon(this.getClass()
